...
Page({
  ...
  data: {
    ...
    isShow: true,  //高级搜索旁边的眼睛
    advanceSearch_lockArea: false,  //高级搜索>锁定地区界面的显示/隐藏
    val:"",  //搜索框里向的值
    ...
    lockAreaLine: false,  //高级搜索>锁定地区按钮下的横线默认不显示
    ...
    shanghaixian_fahua_checked:false,
  ...
  enterInput:function(e){  //搜索函数
    ...
    if(val != ''){  //假使值不等于空额能介
      if(this.data.type == "onVocabularyUnKnown"){  //假使是查查词条不知其字能介
        ...
        }else if(this.data.shanghaiXianRadio == "shanghaixian_fahua"){  //当上海县>法华为真
          this.onVocabularyUnKnownInputTown( "shanghaixian_fahua")
        ...
        if(this.data.shanghaiValueAll == true){
          ...
          this.onVocabularyKnownInputTown("shanghaishi_xujiahui")
            ...
            this.onVocabularyKnownInputTown( "shanghaixian_fahua")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_hongqiao"){ //当上海县>虹桥为真
        ...
        if(this.data.shanghaiValueAll == true){
            ...
            this.onVocabularyMeanInputTown( "shanghaixian_fahua")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_hongqiao"){ //当上海县>虹桥为真
  ...
  onReachBottom: function(e){  //触底函数
    ...
    if(this.data.type == "onVocabularyKnown"){  //如果选中的是知其字的情况下
      if(this.data.shanghaiValueAll == true){
        ...
        this.onVocabularyKnownReachTown( "shanghaixian_fahua")
      }else if(this.data.shanghaiXianRadio == "shanghaixian_hongqiao"){ //当上海县>虹桥为真
      ...
      if(this.data.shanghaiValueAll == true){
        ...
        this.onVocabularyUnKnownReachTown( "shanghaixian_fahua")
      }else if(this.data.shanghaiXianRadio == "shanghaixian_hongqiao"){ //当上海县>虹桥为真
      ...
      if(this.data.shanghaiValueAll == true){
            ...
            this.onVocabularyMeanReachCounty("shanghaishi")
          }else if(this.data.shanghaiShiRadio == "shanghaishi_nanshi"){  //当上海市区>南市为真
            this.onVocabularyKnownReachTown("shanghaishi_nanshi")
          }else if(this.data.shanghaiShiRadio == "shanghaishi_xujiahui"){  //当上海市区>徐家汇为真
            this.onVocabularyKnownReachTown("shanghaishi_xujiahui")
  ...
  shanghaiShiBtn: function(e){
    this.setData({
      ...
      //重置所有镇的value为全部
      shanghaiShiRadio:"shanghaishi_all",
      shanghaiXianRadio:"shanghaishi_all",
      songjiangRadio:"shanghaishi_all",
      jinshanRadio:"shanghaishi_all",
      qingpuRadio:"shanghaishi_all",
      fengxianRadio:"shanghaishi_all",
      chuanshaRadio:"shanghaishi_all",
      nanhuiRadio:"shanghaishi_all",
      jiadingRadio:"shanghaishi_all",
      baoshanRadio:"shanghaishi_all",
      chongmingRadio:"shanghaishi_all",
      //set交互选中的县与镇
      countyName:"上海市区",  //县
      townName:"全境",  //镇
      shanghaiValueAll: false,
      lockAreaLine: true,  //横线显示
      shanghaiShiRadio:"shanghaishi_all",
      //关于数据的
      noData:[],  //将状态栏设置为空
      page: 0,  //将将来要数据库中的页码也设置为0
  ...
  shanghaiXianBtn: function(e){
    this.setData({
      ...
      shanghaixian_beixinjing_checked: false,
      //重置所有镇的value为全部
      shanghaiShiRadio:"shanghaixian_all",
      shanghaiXianRadio:"shanghaixian_all",
      songjiangRadio:"shanghaixian_all",
      jinshanRadio:"shanghaixian_all",
      qingpuRadio:"shanghaixian_all",
      fengxianRadio:"shanghaixian_all",
      chuanshaRadio:"shanghaixian_all",
      nanhuiRadio:"shanghaixian_all",
      jiadingRadio:"shanghaixian_all",
      baoshanRadio:"shanghaixian_all",
      chongmingRadio:"shanghaixian_all",
      //set交互选中的县与镇
      countyName:"上海县",  //县
      townName:"全境",  //镇
      shanghaiValueAll: false,
  ...
  songjiangBtn: function(e){
    this.setData({
      ...
      songjiang_songjiangzhen_checked: false,
      //重置所有镇的value为全部
      shanghaiShiRadio:"songjiang_all",
      shanghaiXianRadio:"songjiang_all",
      songjiangRadio:"songjiang_all",
      jinshanRadio:"songjiang_all",
      qingpuRadio:"songjiang_all",
      fengxianRadio:"songjiang_all",
      chuanshaRadio:"songjiang_all",
      nanhuiRadio:"songjiang_all",
      jiadingRadio:"songjiang_all",
      baoshanRadio:"songjiang_all",
      chongmingRadio:"songjiang_all",
      //set交互选中的县与镇
      countyName:"松江",  //县
      townName:"全境",  //镇
      shanghaiValueAll: false,
  ...
  jinshanBtn: function(e){
    this.setData({
      ...
      //重置所有镇的value为全部
      shanghaiShiRadio:"jinshan_all",
      shanghaiXianRadio:"jinshan_all",
      songjiangRadio:"jinshan_all",
      jinshanRadio:"jinshan_all",
      qingpuRadio:"jinshan_all",
      fengxianRadio:"jinshan_all",
      chuanshaRadio:"jinshan_all",
      nanhuiRadio:"jinshan_all",
      jiadingRadio:"jinshan_all",
      baoshanRadio:"jinshan_all",
      chongmingRadio:"jinshan_all",
      //set交互选中的县与镇
      countyName:"金山",  //县
      townName:"全境",  //镇
      shanghaiValueAll: false,
  ...
  qingpuBtn: function(e){
    this.setData({
      ...
      //重置所有镇的value为全部
      shanghaiShiRadio:"qingpu_all",
      shanghaiXianRadio:"qingpu_all",
      songjiangRadio:"qingpu_all",
      jinshanRadio:"qingpu_all",
      qingpuRadio:"qingpu_all",
      fengxianRadio:"qingpu_all",
      chuanshaRadio:"qingpu_all",
      nanhuiRadio:"qingpu_all",
      jiadingRadio:"qingpu_all",
      baoshanRadio:"qingpu_all",
      chongmingRadio:"qingpu_all",
      //set交互选中的县与镇
      countyName:"青浦",  //县
      townName:"全境",  //镇
      shanghaiValueAll: false,
  ...
  fengxianBtn: function(e){
    this.setData({
      ...
      fengxian_zhelin_nanshanhua_checked:false,
      //重置所有镇的value为全部
      shanghaiShiRadio:"fengxian_all",
      shanghaiXianRadio:"fengxian_all",
      songjiangRadio:"fengxian_all",
      jinshanRadio:"fengxian_all",
      qingpuRadio:"fengxian_all",
      fengxianRadio:"fengxian_all",
      chuanshaRadio:"fengxian_all",
      nanhuiRadio:"fengxian_all",
      jiadingRadio:"fengxian_all",
      baoshanRadio:"fengxian_all",
      chongmingRadio:"fengxian_all",
      //set交互选中的县与镇
      countyName:"奉贤",  //县
      townName:"全境",  //镇
      shanghaiValueAll: false,
  ...
  chuanshaBtn: function(e){
    this.setData({
      ...
      chuansha_chuanshazhen_checked:false,
      //重置所有镇的value为全部
      shanghaiShiRadio:"chuansha_all",
      shanghaiXianRadio:"chuansha_all",
      songjiangRadio:"chuansha_all",
      jinshanRadio:"chuansha_all",
      qingpuRadio:"chuansha_all",
      fengxianRadio:"chuansha_all",
      chuanshaRadio:"chuansha_all",
      nanhuiRadio:"chuansha_all",
      jiadingRadio:"chuansha_all",
      baoshanRadio:"chuansha_all",
      chongmingRadio:"chuansha_all",
      //set交互选中的县与镇
      countyName:"川沙",  //县
      townName:"全境",  //镇
      shanghaiValueAll: false,
  ...
  nanhuiBtn: function(e){
    this.setData({
      ...
      nanhui_luchaogang_checked:false,
      //重置所有镇的value为全部
      shanghaiShiRadio:"nanhui_all",
      shanghaiXianRadio:"nanhui_all",
      songjiangRadio:"nanhui_all",
      jinshanRadio:"nanhui_all",
      qingpuRadio:"nanhui_all",
      fengxianRadio:"nanhui_all",
      chuanshaRadio:"nanhui_all",
      nanhuiRadio:"nanhui_all",
      jiadingRadio:"nanhui_all",
      baoshanRadio:"nanhui_all",
      chongmingRadio:"nanhui_all",
      //set交互选中的县与镇
      countyName:"南汇",  //县
      townName:"全境",  //镇
      shanghaiValueAll: false,
  ...
  jiadingBtn: function(e){
    this.setData({
      ...
      jiading_jiadingzhen_checked:false,
      //重置所有镇的value为全部
      shanghaiShiRadio:"jiading_all",
      shanghaiXianRadio:"jiading_all",
      songjiangRadio:"jiading_all",
      jinshanRadio:"jiading_all",
      qingpuRadio:"jiading_all",
      fengxianRadio:"jiading_all",
      chuanshaRadio:"jiading_all",
      nanhuiRadio:"jiading_all",
      jiadingRadio:"jiading_all",
      baoshanRadio:"jiading_all",
      chongmingRadio:"jiading_all",
      //set交互选中的县与镇
      countyName:"嘉定",  //县
      townName:"全境",  //镇
      shanghaiValueAll: false,
  ...
  baoshanBtn: function(e){
    this.setData({
      ...
      baoshan_shuangcaodun_checked:false,
      //重置所有镇的value为全部
      shanghaiShiRadio:"baoshan_all",
      shanghaiXianRadio:"baoshan_all",
      songjiangRadio:"baoshan_all",
      jinshanRadio:"baoshan_all",
      qingpuRadio:"baoshan_all",
      fengxianRadio:"baoshan_all",
      chuanshaRadio:"baoshan_all",
      nanhuiRadio:"baoshan_all",
      jiadingRadio:"baoshan_all",
      baoshanRadio:"baoshan_all",
      chongmingRadio:"baoshan_all",
      //set交互选中的县与镇
      countyName:"宝山",  //县
      townName:"全境",  //镇
      shanghaiValueAll: false,
  ...
  chongmingBtn: function(e){
    this.setData({
      ...
      chongming_gangyan_checked:false,  
      //重置所有镇的value为全部
      shanghaiShiRadio:"chongming_all",
      shanghaiXianRadio:"chongming_all",
      songjiangRadio:"chongming_all",
      jinshanRadio:"chongming_all",
      qingpuRadio:"chongming_all",
      fengxianRadio:"chongming_all",
      chuanshaRadio:"chongming_all",
      nanhuiRadio:"chongming_all",
      jiadingRadio:"chongming_all",
      baoshanRadio:"chongming_all",
      chongmingRadio:"chongming_all",
      //set交互选中的县与镇
      countyName:"崇明",  //县
      townName:"全境",  //镇
  ...
  shanghaiXianChange: function(e){
    ...
    }else if(e.detail.value == "shanghaixian_fahua"){  //当上海县>法华为真
      this.setData({
        townName: "法华",
        noData:[],  //将状态栏设置为空
        page: 0,  //将将来要数据库中的页码也设置为0
        ...
        list:"",  //将“list“设置为空
        reachBottom: "",
        shanghaiXianRadio: "shanghaixian_fahua"
      })
