...
Page({
  ...
  data: {
    ...
    type2:"onWord",  //排序radio中的默认值为onWord
    list:[],  //要返回数据的列表
    list2:[],
    noData:[], 　//普通的要set的列表 
    page: 0,  //触底时的默认页码
    ...
    songjiang_maogang_checked: false,
  ...
  changeSort(e){  //切换排序所用函数
    this.setData({
      type2: e.detail.value,  //将类型设置为获取
      noData:[],  //将状态栏设置为空
      page: 0,  //将将来要数据库中的页码也设置为0
      reachBottom:"",  //将“到底了”设置为空
      list:"",  //将“list“设置为空
  ...
  enterInput:function(e){  //搜索函数
    ...
    if(val != ''){  //假使值不等于空额能介
      if(this.data.type == "onVocabularyUnKnown"){  //假使是查查词条不知其字能介
        if(this.data.type2 == "onWord"){  //假使选择了是按地区排序的话
         ...
         }else if(this.data.songjiangRadio == "songjiang_maogang"){
           this.onVocabularyUnKnownInputTown("songjiang_maogang")
          ...
          if(this.data.shanghaiValueAll == true){
            wx.cloud.callFunction({  //请求数据库
              ...
              if(res.result.data != ""){  //假使请求到了能介
                ...
                list.sort((a,b) => {  //用户选择了按首字排序的，加入的排序
                  return b.originalEntry.localeCompare(a.originalEntry,'zh-Hans-CN')
                })
                this.setData({
                  list: list
                })
          ...
          this.onVocabularyUnKnownInputCountySort("comprehensive_search")
        }else if(this.data.shanghaiShiRadio == "shanghaishi_all"){  //当上海市区>全境为真
          this.onVocabularyUnKnownInputCountySort("shanghaishi")
        }else if(this.data.shanghaiShiRadio == "shanghaishi_nanshi"){  //当上海市区>南市为真
          this.onVocabularyUnKnownInputTownSort("shanghaishi_nanshi")
        }else if(this.data.shanghaiShiRadio == "shanghaishi_xujiahui"){  //当上海市区>徐家汇为真
          this.onVocabularyUnKnownInputTownSort("shanghaishi_xujiahui")
        }else if(this.data.shanghaiShiRadio == "shanghaishi_fahua"){
          this.onVocabularyUnKnownInputTownSort("shanghaishi_fahua")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_all"){  //当上海县>全境为真
          this.onVocabularyUnKnownInputCountySort( "shanghaixian")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_beiqiao"){  //当上海县>北桥为真
          this.onVocabularyUnKnownInputTownSort( "shanghaixian_beiqiao")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_chenhang"){  //当上海县>陈行为真
          this.onVocabularyUnKnownInputTownSort( "shanghaixian_chenhang")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_duhang"){  //当上海县>杜行为真
          this.onVocabularyUnKnownInputTownSort( "shanghaixian_duhang")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_hongqiao"){ //当上海县>虹桥为真
          this.onVocabularyUnKnownInputTownSort( "shanghaixian_hongqiao")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_huacao"){  //当上海县>华漕为真
          this.onVocabularyUnKnownInputTownSort( "shanghaixian_huacao")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_huajing"){  //当上海县>华泾为真
          this.onVocabularyUnKnownInputTownSort( "shanghaixian_huajing")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_jiwang"){  //当上海县>纪王为真
          this.onVocabularyUnKnownInputTownSort( "shanghaixian_jiwang")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_longhua"){  //当上海县>龙华为真
          this.onVocabularyUnKnownInputTownSort( "shanghaixian_longhua")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_luhui"){  //当上海县>鲁汇为真
          this.onVocabularyUnKnownInputTownSort( "shanghaixian_luhui")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_meilong"){  //当上海县>梅陇为真
          this.onVocabularyUnKnownInputTownSort( "shanghaixian_meilong")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_qibao"){  //当上海县>七宝为真
          this.onVocabularyUnKnownInputTownSort( "shanghaixian_qibao")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_sanlin"){  //当上海县>三林为真
          this.onVocabularyUnKnownInputTownSort( "shanghaixian_sanlin")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_xinzhuang"){  //当上海县>莘庄
          this.onVocabularyUnKnownInputTownSort( "shanghaixian_xinzhuang")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_tangwan"){  //当上海县>塘湾为真
          this.onVocabularyUnKnownInputTownSort( "shanghaixian_tangwan")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_wujing"){  //当上海县>吴泾为真
          this.onVocabularyUnKnownInputTownSort( "shanghaixian_wujing")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_xinjing"){  //当上海县>新泾为真
          this.onVocabularyUnKnownInputTownSort( "shanghaixian_xinjing")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_zhudi"){  //当上海县>诸翟为真
          this.onVocabularyUnKnownInputTownSort( "shanghaixian_zhudi")
        }else if(this.data.shanghaiXianRadio == "shanghaixian_zhuanqiao"){  //当上海县>颛桥为真
          this.onVocabularyUnKnownInputTownSort( "shanghaixian_zhuanqiao")
        }else if(this.data.songjiangRadio == "songjiang_all"){
          this.onVocabularyUnKnownInputCountySort( "songjiang")
        }else if(this.data.songjiangRadio == "songjiang_cangqiao"){
          this.onVocabularyUnKnownInputTownSort( "songjiang_cangqiao")
        }else if(this.data.songjiangRadio == "songjiang_chedun"){
          this.onVocabularyUnKnownInputTownSort( "songjiang_chedun")
        }else if(this.data.songjiangRadio == "songjiang_dongjing"){
          this.onVocabularyUnKnownInputTownSort( "songjiang_dongjing")
        }else if(this.data.songjiangRadio == "songjiang_jiuting"){
          this.onVocabularyUnKnownInputTownSort( "songjiang_jiuting")
        }else if(this.data.songjiangRadio == "songjiang_sheshan"){
          this.onVocabularyUnKnownInputTownSort( "songjiang_sheshan")
        }else if(this.data.songjiangRadio == "songjiang_sijing"){
          this.onVocabularyUnKnownInputTownSort( "songjiang_sijing")
        }else if(this.data.songjiangRadio == "songjiang_xinbang"){
          this.onVocabularyUnKnownInputTownSort( "songjiang_xinbang")
        }else if(this.data.songjiangRadio == "songjiang_xinqiao"){
          this.onVocabularyUnKnownInputTownSort( "songjiang_xinqiao")
        }else if(this.data.songjiangRadio == "songjiang_yexie"){
          this.onVocabularyUnKnownInputTownSort( "songjiang_yexie")
        }else if(this.data.songjiangRadio == "songjiang_zhangze"){
          this.onVocabularyUnKnownInputTownSort( "songjiang_zhangze")
        }else if(this.data.songjiangRadio == "songjiang_shihudang"){
          this.onVocabularyUnKnownInputTownSort( "songjiang_shihudang")
        }else if(this.data.songjiangRadio == "songjiang_tianmashan"){
          this.onVocabularyUnKnownInputTownSort( "songjiang_tianmashan")  
        }else if(this.data.songjiangRadio == "songjiang_wulitang"){
          this.onVocabularyUnKnownInputTownSort( "songjiang_wulitang")   
        }else if(this.data.songjiangRadio == "songjiang_xiaokunshan"){
          this.onVocabularyUnKnownInputTownSort( "songjiang_xiaokunshan")   
        }else if(this.data.songjiangRadio == "songjiang_songjiangzhen"){
          this.onVocabularyUnKnownInputTownSort( "songjiang_songjiangzhen")
        }else if(this.data.songjiangRadio == "songjiang_maogang"){
          this.onVocabularyUnKnownInputTown("songjiang_maogang")
        }else if(this.data.jinshanRadio == "jinshan_all"){
          this.onVocabularyUnKnownInputCountySort( "jinshan")
        }else if(this.data.jinshanRadio == "jinshan_caojing"){
          this.onVocabularyUnKnownInputTownSort( "jinshan_caojing")
        }else if(this.data.jinshanRadio == "jinshan_fengjing"){
          this.onVocabularyUnKnownInputTownSort( "jinshan_fengjing")
        }else if(this.data.jinshanRadio == "jinshan_ganxiang"){
          this.onVocabularyUnKnownInputTownSort( "jinshan_ganxiang")
        }else if(this.data.jinshanRadio == "jinshan_langxia"){
          this.onVocabularyUnKnownInputTownSort( "jinshan_langxia")
        }else if(this.data.jinshanRadio == "jinshan_lvxiang"){
          this.onVocabularyUnKnownInputTownSort( "jinshan_lvxiang")
        }else if(this.data.jinshanRadio == "jinshan_qianyu"){
          this.onVocabularyUnKnownInputTownSort( "jinshan_qianyu")
        }else if(this.data.jinshanRadio == "jinshan_shanyang"){
          this.onVocabularyUnKnownInputTownSort( "jinshan_shanyang")
        }else if(this.data.jinshanRadio == "jinshan_tinglin"){
          this.onVocabularyUnKnownInputTownSort( "jinshan_tinglin")
        }else if(this.data.jinshanRadio == "jinshan_xinnong"){
          this.onVocabularyUnKnownInputTownSort( "jinshan_xinnong")
        }else if(this.data.jinshanRadio == "jinshan_xingta"){
          this.onVocabularyUnKnownInputTownSort( "jinshan_xingta")
        }else if(this.data.jinshanRadio == "jinshan_zhuhang"){
          this.onVocabularyUnKnownInputTownSort( "jinshan_zhuhang")
        }else if(this.data.jinshanRadio == "jinshan_zhujing"){
          this.onVocabularyUnKnownInputTownSort( "jinshan_zhujing")
        }else if(this.data.jinshanRadio == "jinshan_jinshanwei"){
          this.onVocabularyUnKnownInputTownSort( "jinshan_jinshanwei")
        }else if(this.data.qingpuRadio == "qingpu_all"){
          this.onVocabularyUnKnownInputCountySort( "qingpu")
        }else if(this.data.qingpuRadio == "qingpu_baihe"){
            this.onVocabularyUnKnownInputTownSort( "qingpu_baihe")
        }else if(this.data.qingpuRadio == "qingpu_daying"){
            this.onVocabularyUnKnownInputTownSort( "qingpu_daying")
        }else if(this.data.qingpuRadio == "qingpu_fengxi"){
            this.onVocabularyUnKnownInputTownSort( "qingpu_fengxi")
        }else if(this.data.qingpuRadio == "qingpu_huancheng"){
            this.onVocabularyUnKnownInputTownSort( "qingpu_huancheng")
        }else if(this.data.qingpuRadio == "qingpu_jinze"){
            this.onVocabularyUnKnownInputTownSort( "qingpu_jinze")
        }else if(this.data.qingpuRadio == "qingpu_liansheng"){
            this.onVocabularyUnKnownInputTownSort( "qingpu_liansheng")
        }else if(this.data.qingpuRadio == "qingpu_liantang"){
            this.onVocabularyUnKnownInputTownSort( "qingpu_liantang")
        }else if(this.data.qingpuRadio == "qingpu_shangta"){
            this.onVocabularyUnKnownInputTownSort( "qingpu_shangta")
        }else if(this.data.qingpuRadio == "qingpu_shenxiang"){
            this.onVocabularyUnKnownInputTownSort( "qingpu_shenxiang")
        }else if(this.data.qingpuRadio == "qingpu_xiceng"){
            this.onVocabularyUnKnownInputTownSort( "qingpu_xiceng")
        }else if(this.data.qingpuRadio == "qingpu_xiaozheng"){
            this.onVocabularyUnKnownInputTownSort( "qingpu_xiaozheng")
        }else if(this.data.qingpuRadio == "qingpu_xujing"){
            this.onVocabularyUnKnownInputTownSort( "qingpu_xujing")
        }else if(this.data.qingpuRadio == "qingpu_huaxin"){
          this.onVocabularyUnKnownInputTownSort("qingpu_huaxin")
        }else if(this.data.qingpuRadio == "qingpu_yingzhong"){
            this.onVocabularyUnKnownInputTownSort( "qingpu_yingzhong")
        }else if(this.data.qingpuRadio == "qingpu_zhaotun"){
            this.onVocabularyUnKnownInputTownSort( "qingpu_zhaotun")
        }else if(this.data.qingpuRadio == "qingpu_zhaoxiang"){
            this.onVocabularyUnKnownInputTownSort( "qingpu_zhaoxiang")
        }else if(this.data.qingpuRadio == "qingpu_zhengdian"){
            this.onVocabularyUnKnownInputTownSort( "qingpu_zhengdian")
        }else if(this.data.qingpuRadio == "qingpu_chonggu"){
            this.onVocabularyUnKnownInputTownSort( "qingpu_chonggu")
        }else if(this.data.qingpuRadio == "qingpu_zhujiajiao"){
            this.onVocabularyUnKnownInputTownSort( "qingpu_zhujiajiao")
        }else if(this.data.qingpuRadio == "qingpu_xianghuaqiao"){
            this.onVocabularyUnKnownInputTownSort( "qingpu_xianghuaqiao")
        }else if(this.data.qingpuRadio == "qingpu_qingpuzhen"){
            this.onVocabularyUnKnownInputTownSort( "qingpu_qingpuzhen")
        }else if(this.data.fengxianRadio == "fengxian_all"){
            this.onVocabularyUnKnownInputCountySort( "fengxian")
        }else if(this.data.fengxianRadio == "fengxian_fengcheng"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_fengcheng")
        }else if(this.data.fengxianRadio == "fengxian_fengxin"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_fengxin")
        }else if(this.data.fengxianRadio == "fengxian_guangming"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_guangming")
        }else if(this.data.fengxianRadio == "fengxian_hongmiao"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_hongmiao")
        }else if(this.data.fengxianRadio == "fengxian_huqiao"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_huqiao")
        }else if(this.data.fengxianRadio == "fengxian_jianghai"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_jianghai")
        }else if(this.data.fengxianRadio == "fengxian_jinhui"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_jinhui")
        }else if(this.data.fengxianRadio == "fengxian_nanqiao"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_nanqiao")
        }else if(this.data.fengxianRadio == "fengxian_pingan"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_pingan")
        }else if(this.data.fengxianRadio == "fengxian_qianqiao"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_qianqiao")
        }else if(this.data.fengxianRadio == "fengxian_qingcun"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_qingcun")
        }else if(this.data.fengxianRadio == "fengxian_shaochang"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_shaochang")
        }else if(this.data.fengxianRadio == "fengxian_situan"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_situan")
        }else if(this.data.fengxianRadio == "fengxian_tairi"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_tairi")
        }else if(this.data.fengxianRadio == "fengxian_tangwai"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_tangwai")
        }else if(this.data.fengxianRadio == "fengxian_touqiao"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_touqiao")
        }else if(this.data.fengxianRadio == "fengxian_wuqiao"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_wuqiao")
        }else if(this.data.fengxianRadio == "fengxian_xidu"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_xidu")
        }else if(this.data.fengxianRadio == "fengxian_xiaotang"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_xiaotang")
        }else if(this.data.fengxianRadio == "fengxian_xinsi"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_xinsi")
        }else if(this.data.fengxianRadio == "fengxian_zhelin"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_zhelin")
        }else if(this.data.fengxianRadio == "fengxian_zhuanghang"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_zhuanghang")
        }else if(this.data.fengxianRadio == "fengxian_zhelin_nanshanhua"){
            this.onVocabularyUnKnownInputTownSort( "fengxian_zhelin_nanshanhua")
        }else if(this.data.chuanshaRadio == "chuansha_all"){
            this.onVocabularyUnKnownInputCountySort( "chuansha")
        }else if(this.data.chuanshaRadio == "chuansha_beicai"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_beicai")
        }else if(this.data.chuanshaRadio == "chuansha_caolu"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_caolu")
        }else if(this.data.chuanshaRadio == "chuansha_gaodong"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_gaodong")
        }else if(this.data.chuanshaRadio == "chuansha_gaohang"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_gaohang")
        }else if(this.data.chuanshaRadio == "chuansha_gaonan"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_gaonan")
        }else if(this.data.chuanshaRadio == "chuansha_gaoqiao"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_gaoqiao")
        }else if(this.data.chuanshaRadio == "chuansha_heqing"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_heqing")
        }else if(this.data.chuanshaRadio == "chuansha_huamu"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_huamu")
        }else if(this.data.chuanshaRadio == "chuansha_jiangzhen"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_jiangzhen")
        }else if(this.data.chuanshaRadio == "chuansha_shiwan"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_shiwan")
        }else if(this.data.chuanshaRadio == "chuansha_jinqiao"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_jinqiao")
        }else if(this.data.chuanshaRadio == "chuansha_lingqiao"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_lingqiao")
        }else if(this.data.chuanshaRadio == "chuansha_liuli"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_liuli")
        }else if(this.data.chuanshaRadio == "chuansha_tangzhen"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_tangzhen")
        }else if(this.data.chuanshaRadio == "chuansha_wanggang"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_wanggang")
        }else if(this.data.chuanshaRadio == "chuansha_yanqiao"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_wanggang")
        }else if(this.data.chuanshaRadio == "chuansha_yangsi"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_yangsi")
        }else if(this.data.chuanshaRadio == "chuansha_yangyuan"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_yangyuan")
        }else if(this.data.chuanshaRadio == "chuansha_yangjing"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_yangjing")
        }else if(this.data.chuanshaRadio == "chuangsha_zhangjiang"){
            this.onVocabularyUnKnownInputTownSort( "chuangsha_zhangjiang")
        }else if(this.data.chuanshaRadio == "chuansha_zhangqiao"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_zhangqiao")
        }else if(this.data.chuanshaRadio == "chuansha_chuanshazhen"){
            this.onVocabularyUnKnownInputTownSort( "chuansha_chuanshazhen")
        }else if(this.data.nanhuiRadio == "nanhui_all"){
            this.onVocabularyUnKnownInputCountySort( "nanhui")
        }else if(this.data.nanhuiRadio == "nanhui_binhai"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_binhai")
        }else if(this.data.nanhuiRadio == "nanhui_datuan"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_datuan")
        }else if(this.data.nanhuiRadio == "nanhui_donghai"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_donghai")
        }else if(this.data.nanhuiRadio == "nanhui_hangtou"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_hangtou")
        }else if(this.data.nanhuiRadio == "nanhui_hengmian"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_hengmian")
        }else if(this.data.nanhuiRadio == "nanhui_huanglu"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_huanglu")
        }else if(this.data.nanhuiRadio == "nanhui_kangqiao"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_kangqiao")
        }else if(this.data.nanhuiRadio == "nanhui_laogang"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_laogang")
        }else if(this.data.nanhuiRadio == "nanhui_liuzao"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_liuzao")
        }else if(this.data.nanhuiRadio == "nanhui_nicheng"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_nicheng")
        }else if(this.data.nanhuiRadio == "nanhui_pengzhen"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_pengzhen")
        }else if(this.data.nanhuiRadio == "nanhui_sandun"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_sandun")
        }else if(this.data.nanhuiRadio == "nanhui_sanzao"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_sanzao")
        }else if(this.data.nanhuiRadio == "nanhui_shuyuan"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_shuyuan")
        }else if(this.data.nanhuiRadio == "nanhui_tanzhi"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_tanzhi")
        }else if(this.data.nanhuiRadio == "nanhui_waxie"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_waxie")
        }else if(this.data.nanhuiRadio == "nanhui_wanxiang"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_wanxiang")
        }else if(this.data.nanhuiRadio == "nanhui_xiasha"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_xiasha")
        }else if(this.data.nanhuiRadio == "nanhui_xinchang"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_xinchang")
        }else if(this.data.nanhuiRadio == "nanhui_xingang"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_xingang")
        }else if(this.data.nanhuiRadio == "nanhui_xuanqiao"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_xuanqiao")
        }else if(this.data.nanhuiRadio == "nanhui_yancang"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_yancang")
        }else if(this.data.nanhuiRadio == "nanhui_zhoupu"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_zhoupu")
        }else if(this.data.nanhuiRadio == "nanhui_zhuqiao"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_zhuqiao")
        }else if(this.data.nanhuiRadio == "nanhui_luchaogang"){
            this.onVocabularyUnKnownInputTownSort( "nanhui_luchaogang")
        }else if(this.data.jiadingRadio == "jiading_all"){
            this.onVocabularyUnKnownInputCountySort( "jiading")
        }else if(this.data.jiadingRadio == "jiading_anting"){
            this.onVocabularyUnKnownInputTownSort( "jiading_anting")
        }else if(this.data.jiadingRadio == "jiading_fengbang"){
            this.onVocabularyUnKnownInputTownSort( "jiading_fengbang")
        }else if(this.data.jiadingRadio == "jiading_huating"){
            this.onVocabularyUnKnownInputTownSort( "jiading_huating")
        }else if(this.data.jiadingRadio == "jiading_jiangqiao"){
            this.onVocabularyUnKnownInputTownSort( "jiading_jiangqiao")
        }else if(this.data.jiadingRadio == "jiading_loutang"){
            this.onVocabularyUnKnownInputTownSort( "jiading_loutang")
        }else if(this.data.jiadingRadio == "jiading_malu"){
            this.onVocabularyUnKnownInputTownSort( "jiading_malu")
        }else if(this.data.jiadingRadio == "jiading_nanxiang"){
            this.onVocabularyUnKnownInputTownSort( "jiading_nanxiang")
        }else if(this.data.jiadingRadio == "jiading_tanghang"){
            this.onVocabularyUnKnownInputTownSort( "jiading_tanghang")
        }else if(this.data.jiadingRadio == "jiading_taopu"){
            this.onVocabularyUnKnownInputTownSort( "jiading_taopu")
        }else if(this.data.jiadingRadio == "jiading_waigang"){
            this.onVocabularyUnKnownInputTownSort( "jiading_waigang")
        }else if(this.data.jiadingRadio == "jiading_wangxin"){
            this.onVocabularyUnKnownInputTownSort( "jiading_wangxin")
        }else if(this.data.jiadingRadio == "jiading_zhenru"){
            this.onVocabularyUnKnownInputTownSort( "jiading_zhenru")
        }else if(this.data.jiadingRadio == "jiading_jiadingzhen"){
            this.onVocabularyUnKnownInputTownSort( "jiading_jiadingzhen")
        }else if(this.data.baoshanRadio == "baoshan_all"){
            this.onVocabularyUnKnownInputCountySort( "baoshan")
        }else if(this.data.baoshanRadio == "baoshan_dachang"){
            this.onVocabularyUnKnownInputTownSort( "baoshan_dachang")
        }else if(this.data.baoshanRadio == "baoshan_fengtang"){
            this.onVocabularyUnKnownInputTownSort( "baoshan_fengtang")
        }else if(this.data.baoshanRadio == "baoshan_gucun"){
            this.onVocabularyUnKnownInputTownSort( "baoshan_gucun")
        }else if(this.data.baoshanRadio == "baoshan_liuhang"){
            this.onVocabularyUnKnownInputTownSort( "baoshan_liuhang")
        }else if(this.data.baoshanRadio == "baoshan_jiangwan"){
            this.onVocabularyUnKnownInputTownSort( "baoshan_jiangwan")
        }else if(this.data.baoshanRadio == "baoshan_luodian"){
            this.onVocabularyUnKnownInputTownSort( "baoshan_luodian")
        }else if(this.data.baoshanRadio == "baoshan_luojing"){
            this.onVocabularyUnKnownInputTownSort( "baoshan_luojing")
        }else if(this.data.baoshanRadio == "baoshan_luonan"){
            this.onVocabularyUnKnownInputTownSort( "baoshan_luonan")
        }else if(this.data.baoshanRadio == "baoshan_miaohang"){
            this.onVocabularyUnKnownInputTownSort( "baoshan_miaohang")
        }else if(this.data.baoshanRadio == "baoshan_pengpu"){
            this.onVocabularyUnKnownInputTownSort( "baoshan_pengpu")
        }else if(this.data.baoshanRadio == "baoshan_shengqiao"){
            this.onVocabularyUnKnownInputTownSort( "baoshan_shengqiao")
        }else if(this.data.baoshanRadio == "baoshan_songnan"){
            this.onVocabularyUnKnownInputTownSort( "baoshan_songnan")
        }else if(this.data.baoshanRadio == "baoshan_wusong"){
            this.onVocabularyUnKnownInputTownSort( "baoshan_wusong")
        }else if(this.data.baoshanRadio == "baoshan_wujiaochang"){
            this.onVocabularyUnKnownInputTownSort( "baoshan_wujiaochang")
        }else if(this.data.baoshanRadio == "baoshan_shuangcaodun"){
            this.onVocabularyUnKnownInputTownSort( "baoshan_shuangcaodun")
        }else if(this.data.chongmingRadio == "chongming_all"){
            this.onVocabularyUnKnownInputCountySort( "chongming")
        }else if(this.data.chongmingRadio == "chongming_chenjia"){
            this.onVocabularyUnKnownInputTownSort( "chongming_chenjia")
        }else if(this.data.chongmingRadio == "chongming_gangyan"){
          this.onVocabularyUnKnownInputTownSort("chongming_gangyan")
        }
        }   
          ...
          if(this.data.shanghaiValueAll == true){
            ...
            wx.cloud.callFunction({  //链接数据库
              ...
              if(res.result.data != ""){  //做一个判断，假使数据拿到了能介
                ...
                var list = res.result.data
                list.sort((a,b) => {  //用户选择了按首字排序的，加入的排序
                  return b.vocabulary.localeCompare(a.vocabulary,'zh-Hans-CN')
                })
            ...
            this.onVocabularyKnownInputCountySort("comprehensive_search")
          }else if(this.data.shanghaiShiRadio == "shanghaishi_all"){
            this.onVocabularyKnownInputCountySort("shanghaishi")
          }else if(this.data.shanghaiShiRadio == "shanghaishi_nanshi"){
            this.onVocabularyKnownInputTownSort("shanghaishi_nanshi")
          }else if(this.data.shanghaiShiRadio == "shanghaishi_xujiahui"){
            this.onVocabularyKnownInputTownSort("shanghaishi_xujiahui")
          }else if(this.data.shanghaiShiRadio == "shanghaishi_fahua"){
            this.onVocabularyKnownInputTownSort("shanghaishi_fahua")
          }
          else if(this.data.shanghaiXianRadio == "shanghaixian_all"){  //当上海县>全境为真
              this.onVocabularyKnownInputCountySort( "shanghaixian")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_beiqiao"){  //当上海县>北桥为真
              this.onVocabularyKnownInputTownSort( "shanghaixian_beiqiao")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_chenhang"){  //当上海县>陈行为真
              this.onVocabularyKnownInputTownSort( "shanghaixian_chenhang")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_duhang"){  //当上海县>杜行为真
              this.onVocabularyKnownInputTownSort( "shanghaixian_duhang")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_hongqiao"){ //当上海县>虹桥为真
              this.onVocabularyKnownInputTownSort( "shanghaixian_hongqiao")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_huacao"){  //当上海县>华漕为真
              this.onVocabularyKnownInputTownSort( "shanghaixian_huacao")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_huajing"){  //当上海县>华泾为真
              this.onVocabularyKnownInputTownSort( "shanghaixian_huajing")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_jiwang"){  //当上海县>纪王为真
              this.onVocabularyKnownInputTownSort( "shanghaixian_jiwang")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_longhua"){  //当上海县>龙华为真
              this.onVocabularyKnownInputTownSort( "shanghaixian_longhua")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_luhui"){  //当上海县>鲁汇为真
              this.onVocabularyKnownInputTownSort( "shanghaixian_luhui")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_meilong"){  //当上海县>梅陇为真
              this.onVocabularyKnownInputTownSort( "shanghaixian_meilong")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_qibao"){  //当上海县>七宝为真
              this.onVocabularyKnownInputTownSort( "shanghaixian_qibao")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_sanlin"){  //当上海县>三林为真
              this.onVocabularyKnownInputTownSort( "shanghaixian_sanlin")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_xinzhuang"){  //当上海县>莘庄
              this.onVocabularyKnownInputTownSort( "shanghaixian_xinzhuang")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_tangwan"){  //当上海县>塘湾为真
              this.onVocabularyKnownInputTownSort( "shanghaixian_tangwan")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_wujing"){  //当上海县>吴泾为真
              this.onVocabularyKnownInputTownSort( "shanghaixian_wujing")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_xinjing"){  //当上海县>新泾为真
              this.onVocabularyKnownInputTownSort( "shanghaixian_xinjing")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_zhudi"){  //当上海县>诸翟为真
              this.onVocabularyKnownInputTownSort( "shanghaixian_zhudi")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_zhuanqiao"){  //当上海县>颛桥为真
              this.onVocabularyKnownInputTownSort( "shanghaixian_zhuanqiao")
          }else if(this.data.songjiangRadio == "songjiang_all"){
              this.onVocabularyKnownInputCountySort( "songjiang")
          }else if(this.data.songjiangRadio == "songjiang_cangqiao"){
              this.onVocabularyKnownInputTownSort( "songjiang_cangqiao")
          }else if(this.data.songjiangRadio == "songjiang_chedun"){
              this.onVocabularyKnownInputTownSort( "songjiang_chedun")
          }else if(this.data.songjiangRadio == "songjiang_dongjing"){
              this.onVocabularyKnownInputTownSort( "songjiang_dongjing")
          }else if(this.data.songjiangRadio == "songjiang_jiuting"){
              this.onVocabularyKnownInputTownSort( "songjiang_jiuting")
          }else if(this.data.songjiangRadio == "songjiang_sheshan"){
              this.onVocabularyKnownInputTownSort( "songjiang_sheshan")
          }else if(this.data.songjiangRadio == "songjiang_sijing"){
              this.onVocabularyKnownInputTownSort( "songjiang_sijing")
          }else if(this.data.songjiangRadio == "songjiang_xinbang"){
              this.onVocabularyKnownInputTownSort( "songjiang_xinbang")
          }else if(this.data.songjiangRadio == "songjiang_xinqiao"){
              this.onVocabularyKnownInputTownSort( "songjiang_xinqiao")
          }else if(this.data.songjiangRadio == "songjiang_yexie"){
              this.onVocabularyKnownInputTownSort( "songjiang_yexie")
          }else if(this.data.songjiangRadio == "songjiang_zhangze"){
              this.onVocabularyKnownInputTownSort( "songjiang_zhangze")
          }else if(this.data.songjiangRadio == "songjiang_shihudang"){
              this.onVocabularyKnownInputTownSort( "songjiang_shihudang")
          }else if(this.data.songjiangRadio == "songjiang_tianmashan"){
              this.onVocabularyKnownInputTownSort( "songjiang_tianmashan")  
          }else if(this.data.songjiangRadio == "songjiang_wulitang"){
              this.onVocabularyKnownInputTownSort( "songjiang_wulitang")   
          }else if(this.data.songjiangRadio == "songjiang_xiaokunshan"){
              this.onVocabularyKnownInputTownSort( "songjiang_xiaokunshan")   
          }else if(this.data.songjiangRadio == "songjiang_songjiangzhen"){
              this.onVocabularyKnownInputTownSort( "songjiang_songjiangzhen")
          }else if(this.data.songjiangRadio == "songjiang_maogang"){
              this.onVocabularyKnownInputTownSort("songjiang_maogang")
          }else if(this.data.jinshanRadio == "jinshan_all"){
              this.onVocabularyKnownInputCountySort( "jinshan")
          }else if(this.data.jinshanRadio == "jinshan_caojing"){
              this.onVocabularyKnownInputTownSort( "jinshan_caojing")
          }else if(this.data.jinshanRadio == "jinshan_fengjing"){
              this.onVocabularyKnownInputTownSort( "jinshan_fengjing")
          }else if(this.data.jinshanRadio == "jinshan_ganxiang"){
              this.onVocabularyKnownInputTownSort( "jinshan_ganxiang")
          }else if(this.data.jinshanRadio == "jinshan_langxia"){
              this.onVocabularyKnownInputTownSort( "jinshan_langxia")
          }else if(this.data.jinshanRadio == "jinshan_lvxiang"){
              this.onVocabularyKnownInputTownSort( "jinshan_lvxiang")
          }else if(this.data.jinshanRadio == "jinshan_qianyu"){
              this.onVocabularyKnownInputTownSort( "jinshan_qianyu")
          }else if(this.data.jinshanRadio == "jinshan_shanyang"){
              this.onVocabularyKnownInputTownSort( "jinshan_shanyang")
          }else if(this.data.jinshanRadio == "jinshan_tinglin"){
              this.onVocabularyKnownInputTownSort( "jinshan_tinglin")
          }else if(this.data.jinshanRadio == "jinshan_xinnong"){
              this.onVocabularyKnownInputTownSort( "jinshan_xinnong")
          }else if(this.data.jinshanRadio == "jinshan_xingta"){
              this.onVocabularyKnownInputTownSort( "jinshan_xingta")
          }else if(this.data.jinshanRadio == "jinshan_zhuhang"){
              this.onVocabularyKnownInputTownSort( "jinshan_zhuhang")
          }else if(this.data.jinshanRadio == "jinshan_zhujing"){
              this.onVocabularyKnownInputTownSort( "jinshan_zhujing")
          }else if(this.data.jinshanRadio == "jinshan_jinshanwei"){
              this.onVocabularyKnownInputTownSort( "jinshan_jinshanwei")
          }else if(this.data.qingpuRadio == "qingpu_all"){
              this.onVocabularyKnownInputCountySort( "qingpu")
          }else if(this.data.qingpuRadio == "qingpu_baihe"){
              this.onVocabularyKnownInputTownSort( "qingpu_baihe")
          }else if(this.data.qingpuRadio == "qingpu_daying"){
              this.onVocabularyKnownInputTownSort( "qingpu_daying")
          }else if(this.data.qingpuRadio == "qingpu_fengxi"){
              this.onVocabularyKnownInputTownSort( "qingpu_fengxi")
          }else if(this.data.qingpuRadio == "qingpu_huancheng"){
              this.onVocabularyKnownInputTownSort( "qingpu_huancheng")
          }else if(this.data.qingpuRadio == "qingpu_jinze"){
              this.onVocabularyKnownInputTownSort( "qingpu_jinze")
          }else if(this.data.qingpuRadio == "qingpu_liansheng"){
              this.onVocabularyKnownInputTownSort( "qingpu_liansheng")
          }else if(this.data.qingpuRadio == "qingpu_liantang"){
              this.onVocabularyKnownInputTownSort( "qingpu_liantang")
          }else if(this.data.qingpuRadio == "qingpu_shangta"){
              this.onVocabularyKnownInputTownSort( "qingpu_shangta")
          }else if(this.data.qingpuRadio == "qingpu_shenxiang"){
              this.onVocabularyKnownInputTownSort( "qingpu_shenxiang")
          }else if(this.data.qingpuRadio == "qingpu_xiceng"){
              this.onVocabularyKnownInputTownSort( "qingpu_xiceng")
          }else if(this.data.qingpuRadio == "qingpu_xiaozheng"){
              this.onVocabularyKnownInputTownSort( "qingpu_xiaozheng")
          }else if(this.data.qingpuRadio == "qingpu_xujing"){
            this.onVocabularyKnownInputTownSort( "qingpu_xujing")
          }else if(this.data.qingpuRadio == "qingpu_huaxin"){
            this.onVocabularyKnownInputTownSort("qingpu_huaxin")
          }else if(this.data.qingpuRadio == "qingpu_yingzhong"){
            this.onVocabularyKnownInputTownSort( "qingpu_yingzhong")
          }else if(this.data.qingpuRadio == "qingpu_zhaotun"){
              this.onVocabularyKnownInputTownSort( "qingpu_zhaotun")
          }else if(this.data.qingpuRadio == "qingpu_zhaoxiang"){
              this.onVocabularyKnownInputTownSort( "qingpu_zhaoxiang")
          }else if(this.data.qingpuRadio == "qingpu_zhengdian"){
              this.onVocabularyKnownInputTownSort( "qingpu_zhengdian")
          }else if(this.data.qingpuRadio == "qingpu_chonggu"){
              this.onVocabularyKnownInputTownSort( "qingpu_chonggu")
          }else if(this.data.qingpuRadio == "qingpu_zhujiajiao"){
              this.onVocabularyKnownInputTownSort( "qingpu_zhujiajiao")
          }else if(this.data.qingpuRadio == "qingpu_xianghuaqiao"){
              this.onVocabularyKnownInputTownSort( "qingpu_xianghuaqiao")
          }else if(this.data.qingpuRadio == "qingpu_qingpuzhen"){
              this.onVocabularyKnownInputTownSort( "qingpu_qingpuzhen")
          }else if(this.data.fengxianRadio == "fengxian_all"){
              this.onVocabularyKnownInputCountySort( "fengxian")
          }else if(this.data.fengxianRadio == "fengxian_fengcheng"){
              this.onVocabularyKnownInputTownSort( "fengxian_fengcheng")
          }else if(this.data.fengxianRadio == "fengxian_fengxin"){
              this.onVocabularyKnownInputTownSort( "fengxian_fengxin")
          }else if(this.data.fengxianRadio == "fengxian_guangming"){
              this.onVocabularyKnownInputTownSort( "fengxian_guangming")
          }else if(this.data.fengxianRadio == "fengxian_hongmiao"){
              this.onVocabularyKnownInputTownSort( "fengxian_hongmiao")
          }else if(this.data.fengxianRadio == "fengxian_huqiao"){
              this.onVocabularyKnownInputTownSort( "fengxian_huqiao")
          }else if(this.data.fengxianRadio == "fengxian_jianghai"){
              this.onVocabularyKnownInputTownSort( "fengxian_jianghai")
          }else if(this.data.fengxianRadio == "fengxian_jinhui"){
              this.onVocabularyKnownInputTownSort( "fengxian_jinhui")
          }else if(this.data.fengxianRadio == "fengxian_nanqiao"){
              this.onVocabularyKnownInputTownSort( "fengxian_nanqiao")
          }else if(this.data.fengxianRadio == "fengxian_pingan"){
              this.onVocabularyKnownInputTownSort( "fengxian_pingan")
          }else if(this.data.fengxianRadio == "fengxian_qianqiao"){
              this.onVocabularyKnownInputTownSort( "fengxian_qianqiao")
          }else if(this.data.fengxianRadio == "fengxian_qingcun"){
              this.onVocabularyKnownInputTownSort( "fengxian_qingcun")
          }else if(this.data.fengxianRadio == "fengxian_shaochang"){
              this.onVocabularyKnownInputTownSort( "fengxian_shaochang")
          }else if(this.data.fengxianRadio == "fengxian_situan"){
              this.onVocabularyKnownInputTownSort( "fengxian_situan")
          }else if(this.data.fengxianRadio == "fengxian_tairi"){
              this.onVocabularyKnownInputTownSort( "fengxian_tairi")
          }else if(this.data.fengxianRadio == "fengxian_tangwai"){
              this.onVocabularyKnownInputTownSort( "fengxian_tangwai")
          }else if(this.data.fengxianRadio == "fengxian_touqiao"){
              this.onVocabularyKnownInputTownSort( "fengxian_touqiao")
          }else if(this.data.fengxianRadio == "fengxian_wuqiao"){
              this.onVocabularyKnownInputTownSort( "fengxian_wuqiao")
          }else if(this.data.fengxianRadio == "fengxian_xidu"){
              this.onVocabularyKnownInputTownSort( "fengxian_xidu")
          }else if(this.data.fengxianRadio == "fengxian_xiaotang"){
              this.onVocabularyKnownInputTownSort( "fengxian_xiaotang")
          }else if(this.data.fengxianRadio == "fengxian_xinsi"){
              this.onVocabularyKnownInputTownSort( "fengxian_xinsi")
          }else if(this.data.fengxianRadio == "fengxian_zhelin"){
              this.onVocabularyKnownInputTownSort( "fengxian_zhelin")
          }else if(this.data.fengxianRadio == "fengxian_zhuanghang"){
              this.onVocabularyKnownInputTownSort( "fengxian_zhuanghang")
          }else if(this.data.fengxianRadio == "fengxian_zhelin_nanshanhua"){
              this.onVocabularyKnownInputTownSort( "fengxian_zhelin_nanshanhua")
          }else if(this.data.chuanshaRadio == "chuansha_all"){
              this.onVocabularyKnownInputCountySort( "chuansha")
          }else if(this.data.chuanshaRadio == "chuansha_beicai"){
              this.onVocabularyKnownInputTownSort( "chuansha_beicai")
          }else if(this.data.chuanshaRadio == "chuansha_caolu"){
              this.onVocabularyKnownInputTownSort( "chuansha_caolu")
          }else if(this.data.chuanshaRadio == "chuansha_gaodong"){
              this.onVocabularyKnownInputTownSort( "chuansha_gaodong")
          }else if(this.data.chuanshaRadio == "chuansha_gaohang"){
              this.onVocabularyKnownInputTownSort( "chuansha_gaohang")
          }else if(this.data.chuanshaRadio == "chuansha_gaonan"){
              this.onVocabularyKnownInputTownSort( "chuansha_gaonan")
          }else if(this.data.chuanshaRadio == "chuansha_gaoqiao"){
              this.onVocabularyKnownInputTownSort( "chuansha_gaoqiao")
          }else if(this.data.chuanshaRadio == "chuansha_heqing"){
              this.onVocabularyKnownInputTownSort( "chuansha_heqing")
          }else if(this.data.chuanshaRadio == "chuansha_huamu"){
              this.onVocabularyKnownInputTownSort( "chuansha_huamu")
          }else if(this.data.chuanshaRadio == "chuansha_jiangzhen"){
              this.onVocabularyKnownInputTownSort( "chuansha_jiangzhen")
          }else if(this.data.chuanshaRadio == "chuansha_shiwan"){
              this.onVocabularyKnownInputTownSort( "chuansha_shiwan")
          }else if(this.data.chuanshaRadio == "chuansha_jinqiao"){
              this.onVocabularyKnownInputTownSort( "chuansha_jinqiao")
          }else if(this.data.chuanshaRadio == "chuansha_lingqiao"){
              this.onVocabularyKnownInputTownSort( "chuansha_lingqiao")
          }else if(this.data.chuanshaRadio == "chuansha_liuli"){
              this.onVocabularyKnownInputTownSort( "chuansha_liuli")
          }else if(this.data.chuanshaRadio == "chuansha_tangzhen"){
              this.onVocabularyKnownInputTownSort( "chuansha_tangzhen")
          }else if(this.data.chuanshaRadio == "chuansha_wanggang"){
              this.onVocabularyKnownInputTownSort( "chuansha_wanggang")
          }else if(this.data.chuanshaRadio == "chuansha_yanqiao"){
              this.onVocabularyKnownInputTownSort( "chuansha_wanggang")
          }else if(this.data.chuanshaRadio == "chuansha_yangsi"){
              this.onVocabularyKnownInputTownSort( "chuansha_yangsi")
          }else if(this.data.chuanshaRadio == "chuansha_yangyuan"){
              this.onVocabularyKnownInputTownSort( "chuansha_yangyuan")
          }else if(this.data.chuanshaRadio == "chuansha_yangjing"){
              this.onVocabularyKnownInputTownSort( "chuansha_yangjing")
          }else if(this.data.chuanshaRadio == "chuangsha_zhangjiang"){
              this.onVocabularyKnownInputTownSort( "chuangsha_zhangjiang")
          }else if(this.data.chuanshaRadio == "chuansha_zhangqiao"){
              this.onVocabularyKnownInputTownSort( "chuansha_zhangqiao")
          }else if(this.data.chuanshaRadio == "chuansha_chuanshazhen"){
              this.onVocabularyKnownInputTownSort( "chuansha_chuanshazhen")
          }else if(this.data.nanhuiRadio == "nanhui_all"){
              this.onVocabularyKnownInputCountySort( "nanhui")
          }else if(this.data.nanhuiRadio == "nanhui_binhai"){
              this.onVocabularyKnownInputTownSort( "nanhui_binhai")
          }else if(this.data.nanhuiRadio == "nanhui_datuan"){
              this.onVocabularyKnownInputTownSort( "nanhui_datuan")
          }else if(this.data.nanhuiRadio == "nanhui_donghai"){
              this.onVocabularyKnownInputTownSort( "nanhui_donghai")
          }else if(this.data.nanhuiRadio == "nanhui_hangtou"){
              this.onVocabularyKnownInputTownSort( "nanhui_hangtou")
          }else if(this.data.nanhuiRadio == "nanhui_hengmian"){
              this.onVocabularyKnownInputTownSort( "nanhui_hengmian")
          }else if(this.data.nanhuiRadio == "nanhui_huanglu"){
              this.onVocabularyKnownInputTownSort( "nanhui_huanglu")
          }else if(this.data.nanhuiRadio == "nanhui_kangqiao"){
              this.onVocabularyKnownInputTownSort( "nanhui_kangqiao")
          }else if(this.data.nanhuiRadio == "nanhui_laogang"){
              this.onVocabularyKnownInputTownSort( "nanhui_laogang")
          }else if(this.data.nanhuiRadio == "nanhui_liuzao"){
              this.onVocabularyKnownInputTownSort( "nanhui_liuzao")
          }else if(this.data.nanhuiRadio == "nanhui_nicheng"){
              this.onVocabularyKnownInputTownSort( "nanhui_nicheng")
          }else if(this.data.nanhuiRadio == "nanhui_pengzhen"){
              this.onVocabularyKnownInputTownSort( "nanhui_pengzhen")
          }else if(this.data.nanhuiRadio == "nanhui_sandun"){
              this.onVocabularyKnownInputTownSort( "nanhui_sandun")
          }else if(this.data.nanhuiRadio == "nanhui_sanzao"){
              this.onVocabularyKnownInputTownSort( "nanhui_sanzao")
          }else if(this.data.nanhuiRadio == "nanhui_shuyuan"){
              this.onVocabularyKnownInputTownSort( "nanhui_shuyuan")
          }else if(this.data.nanhuiRadio == "nanhui_tanzhi"){
              this.onVocabularyKnownInputTownSort( "nanhui_tanzhi")
          }else if(this.data.nanhuiRadio == "nanhui_waxie"){
              this.onVocabularyKnownInputTownSort( "nanhui_waxie")
          }else if(this.data.nanhuiRadio == "nanhui_wanxiang"){
              this.onVocabularyKnownInputTownSort( "nanhui_wanxiang")
          }else if(this.data.nanhuiRadio == "nanhui_xiasha"){
              this.onVocabularyKnownInputTownSort( "nanhui_xiasha")
          }else if(this.data.nanhuiRadio == "nanhui_xinchang"){
              this.onVocabularyKnownInputTownSort( "nanhui_xinchang")
          }else if(this.data.nanhuiRadio == "nanhui_xingang"){
              this.onVocabularyKnownInputTownSort( "nanhui_xingang")
          }else if(this.data.nanhuiRadio == "nanhui_xuanqiao"){
              this.onVocabularyKnownInputTownSort( "nanhui_xuanqiao")
          }else if(this.data.nanhuiRadio == "nanhui_yancang"){
              this.onVocabularyKnownInputTownSort( "nanhui_yancang")
          }else if(this.data.nanhuiRadio == "nanhui_zhoupu"){
              this.onVocabularyKnownInputTownSort( "nanhui_zhoupu")
          }else if(this.data.nanhuiRadio == "nanhui_zhuqiao"){
              this.onVocabularyKnownInputTownSort( "nanhui_zhuqiao")
          }else if(this.data.nanhuiRadio == "nanhui_luchaogang"){
              this.onVocabularyKnownInputTownSort( "nanhui_luchaogang")
          }else if(this.data.jiadingRadio == "jiading_all"){
              this.onVocabularyKnownInputCountySort( "jiading")
          }else if(this.data.jiadingRadio == "jiading_anting"){
              this.onVocabularyKnownInputTownSort( "jiading_anting")
          }else if(this.data.jiadingRadio == "jiading_fengbang"){
              this.onVocabularyKnownInputTownSort( "jiading_fengbang")
          }else if(this.data.jiadingRadio == "jiading_huating"){
              this.onVocabularyKnownInputTownSort( "jiading_huating")
          }else if(this.data.jiadingRadio == "jiading_jiangqiao"){
              this.onVocabularyKnownInputTownSort( "jiading_jiangqiao")
          }else if(this.data.jiadingRadio == "jiading_loutang"){
              this.onVocabularyKnownInputTownSort( "jiading_loutang")
          }else if(this.data.jiadingRadio == "jiading_malu"){
              this.onVocabularyKnownInputTownSort( "jiading_malu")
          }else if(this.data.jiadingRadio == "jiading_nanxiang"){
              this.onVocabularyKnownInputTownSort( "jiading_nanxiang")
          }else if(this.data.jiadingRadio == "jiading_tanghang"){
              this.onVocabularyKnownInputTownSort( "jiading_tanghang")
          }else if(this.data.jiadingRadio == "jiading_taopu"){
              this.onVocabularyKnownInputTownSort( "jiading_taopu")
          }else if(this.data.jiadingRadio == "jiading_waigang"){
              this.onVocabularyKnownInputTownSort( "jiading_waigang")
          }else if(this.data.jiadingRadio == "jiading_wangxin"){
              this.onVocabularyKnownInputTownSort( "jiading_wangxin")
          }else if(this.data.jiadingRadio == "jiading_zhenru"){
              this.onVocabularyKnownInputTownSort( "jiading_zhenru")
          }else if(this.data.jiadingRadio == "jiading_jiadingzhen"){
              this.onVocabularyKnownInputTownSort( "jiading_jiadingzhen")
          }else if(this.data.baoshanRadio == "baoshan_all"){
              this.onVocabularyKnownInputCountySort( "baoshan")
          }else if(this.data.baoshanRadio == "baoshan_dachang"){
              this.onVocabularyKnownInputTownSort( "baoshan_dachang")
          }else if(this.data.baoshanRadio == "baoshan_fengtang"){
              this.onVocabularyKnownInputTownSort( "baoshan_fengtang")
          }else if(this.data.baoshanRadio == "baoshan_gucun"){
              this.onVocabularyKnownInputTownSort( "baoshan_gucun")
          }else if(this.data.baoshanRadio == "baoshan_liuhang"){
              this.onVocabularyKnownInputTownSort( "baoshan_liuhang")
          }else if(this.data.baoshanRadio == "baoshan_jiangwan"){
              this.onVocabularyKnownInputTownSort( "baoshan_jiangwan")
          }else if(this.data.baoshanRadio == "baoshan_luodian"){
              this.onVocabularyKnownInputTownSort( "baoshan_luodian")
          }else if(this.data.baoshanRadio == "baoshan_luojing"){
              this.onVocabularyKnownInputTownSort( "baoshan_luojing")
          }else if(this.data.baoshanRadio == "baoshan_luonan"){
              this.onVocabularyKnownInputTownSort( "baoshan_luonan")
          }else if(this.data.baoshanRadio == "baoshan_miaohang"){
              this.onVocabularyKnownInputTownSort( "baoshan_miaohang")
          }else if(this.data.baoshanRadio == "baoshan_pengpu"){
              this.onVocabularyKnownInputTownSort( "baoshan_pengpu")
          }else if(this.data.baoshanRadio == "baoshan_shengqiao"){
              this.onVocabularyKnownInputTownSort( "baoshan_shengqiao")
          }else if(this.data.baoshanRadio == "baoshan_songnan"){
              this.onVocabularyKnownInputTownSort( "baoshan_songnan")
          }else if(this.data.baoshanRadio == "baoshan_wusong"){
              this.onVocabularyKnownInputTownSort( "baoshan_wusong")
          }else if(this.data.baoshanRadio == "baoshan_wujiaochang"){
              this.onVocabularyKnownInputTownSort( "baoshan_wujiaochang")
          }else if(this.data.baoshanRadio == "baoshan_shuangcaodun"){
              this.onVocabularyKnownInputTownSort( "baoshan_shuangcaodun")
          }else if(this.data.chongmingRadio == "chongming_all"){
              this.onVocabularyKnownInputCountySort( "chongming")
          }else if(this.data.chongmingRadio == "chongming_chenjia"){
              this.onVocabularyKnownInputTownSort( "chongming_chenjia")
          }else if(this.data.chongmingRadio == "chongming_gangyan"){
              this.onVocabularyKnownInputTownSort( "chongming_gangyan")
          }
        } 
      }else{  //假使是查释义能介
        if(this.data.type2 == "onWord"){  //假使选择了是按地区排序的话
          if(this.data.shanghaiValueAll == true){
            ...
            this.onVocabularyMeanInputTown("shanghaishi_fahua")
              ...
              this.onVocabularyMeanInputTown("songjiang_maogang")
          }else if(this.data.jinshanRadio == "jinshan_all"){
          ...
          if(this.data.shanghaiValueAll == true){
            wx.cloud.callFunction({
              ...
              if(res.result.data != ""){  //假使请求着
                ...
                var list = res.result.data
                list.sort((a,b) => {  //用户选择了按首字排序的，加入的排序
                  return b.explanation.localeCompare(a.explanation,'zh-Hans-CN')
                })
                this.setData({
                  list: list
                })
            ...
            this.onVocabularyMeanInputCountySort("comprehensive_search")
          }else if(this.data.shanghaiShiRadio == "shanghaishi_all"){  //当上海市区>全境为真
            this.onVocabularyMeanInputCountySort("shanghaishi")
          }else if(this.data.shanghaiShiRadio == "shanghaishi_nanshi"){  //当上海市区>南市为真
              this.onVocabularyMeanInputTownSort("shanghaishi_nanshi")
          }else if(this.data.shanghaiShiRadio == "shanghaishi_xujiahui"){  //当上海市区>徐家汇为真
              this.onVocabularyMeanInputTownSort("shanghaishi_xujiahui")
          }else if(this.data.shanghaiShiRadio == "shanghaishi_fahua"){
            this.onVocabularyMeanInputTownSort("shanghaishi_fahua")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_all"){  //当上海县>全境为真
              this.onVocabularyMeanInputCountySort( "shanghaixian")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_beiqiao"){  //当上海县>北桥为真
              this.onVocabularyMeanInputTownSort( "shanghaixian_beiqiao")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_chenhang"){  //当上海县>陈行为真
              this.onVocabularyMeanInputTownSort( "shanghaixian_chenhang")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_duhang"){  //当上海县>杜行为真
              this.onVocabularyMeanInputTownSort( "shanghaixian_duhang")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_hongqiao"){ //当上海县>虹桥为真
              this.onVocabularyMeanInputTownSort( "shanghaixian_hongqiao")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_huacao"){  //当上海县>华漕为真
              this.onVocabularyMeanInputTownSort( "shanghaixian_huacao")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_huajing"){  //当上海县>华泾为真
              this.onVocabularyMeanInputTownSort( "shanghaixian_huajing")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_jiwang"){  //当上海县>纪王为真
              this.onVocabularyMeanInputTownSort( "shanghaixian_jiwang")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_longhua"){  //当上海县>龙华为真
              this.onVocabularyMeanInputTownSort( "shanghaixian_longhua")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_luhui"){  //当上海县>鲁汇为真
              this.onVocabularyMeanInputTownSort( "shanghaixian_luhui")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_meilong"){  //当上海县>梅陇为真
              this.onVocabularyMeanInputTownSort( "shanghaixian_meilong")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_qibao"){  //当上海县>七宝为真
              this.onVocabularyMeanInputTownSort( "shanghaixian_qibao")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_sanlin"){  //当上海县>三林为真
              this.onVocabularyMeanInputTownSort( "shanghaixian_sanlin")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_xinzhuang"){  //当上海县>莘庄
              this.onVocabularyMeanInputTownSort( "shanghaixian_xinzhuang")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_tangwan"){  //当上海县>塘湾为真
              this.onVocabularyMeanInputTownSort( "shanghaixian_tangwan")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_wujing"){  //当上海县>吴泾为真
              this.onVocabularyMeanInputTownSort( "shanghaixian_wujing")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_xinjing"){  //当上海县>新泾为真
              this.onVocabularyMeanInputTownSort( "shanghaixian_xinjing")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_zhudi"){  //当上海县>诸翟为真
              this.onVocabularyMeanInputTownSort( "shanghaixian_zhudi")
          }else if(this.data.shanghaiXianRadio == "shanghaixian_zhuanqiao"){  //当上海县>颛桥为真
              this.onVocabularyMeanInputTownSort( "shanghaixian_zhuanqiao")
          }else if(this.data.songjiangRadio == "songjiang_all"){
              this.onVocabularyMeanInputCountySort( "songjiang")
          }else if(this.data.songjiangRadio == "songjiang_cangqiao"){
              this.onVocabularyMeanInputTownSort( "songjiang_cangqiao")
          }else if(this.data.songjiangRadio == "songjiang_chedun"){
              this.onVocabularyMeanInputTownSort( "songjiang_chedun")
          }else if(this.data.songjiangRadio == "songjiang_dongjing"){
              this.onVocabularyMeanInputTownSort( "songjiang_dongjing")
          }else if(this.data.songjiangRadio == "songjiang_jiuting"){
              this.onVocabularyMeanInputTownSort( "songjiang_jiuting")
          }else if(this.data.songjiangRadio == "songjiang_sheshan"){
              this.onVocabularyMeanInputTownSort( "songjiang_sheshan")
          }else if(this.data.songjiangRadio == "songjiang_sijing"){
              this.onVocabularyMeanInputTownSort( "songjiang_sijing")
          }else if(this.data.songjiangRadio == "songjiang_xinbang"){
              this.onVocabularyMeanInputTownSort( "songjiang_xinbang")
          }else if(this.data.songjiangRadio == "songjiang_xinqiao"){
              this.onVocabularyMeanInputTownSort( "songjiang_xinqiao")
          }else if(this.data.songjiangRadio == "songjiang_yexie"){
              this.onVocabularyMeanInputTownSort( "songjiang_yexie")
          }else if(this.data.songjiangRadio == "songjiang_zhangze"){
              this.onVocabularyMeanInputTownSort( "songjiang_zhangze")
          }else if(this.data.songjiangRadio == "songjiang_shihudang"){
              this.onVocabularyMeanInputTownSort( "songjiang_shihudang")
          }else if(this.data.songjiangRadio == "songjiang_tianmashan"){
              this.onVocabularyMeanInputTownSort( "songjiang_tianmashan")  
          }else if(this.data.songjiangRadio == "songjiang_wulitang"){
              this.onVocabularyMeanInputTownSort( "songjiang_wulitang")   
          }else if(this.data.songjiangRadio == "songjiang_xiaokunshan"){
              this.onVocabularyMeanInputTownSort( "songjiang_xiaokunshan")   
          }else if(this.data.songjiangRadio == "songjiang_songjiangzhen"){
              this.onVocabularyMeanInputTownSort( "songjiang_songjiangzhen")
          }else if(this.data.songjiangRadio == "songjiang_maogang"){
            this.onVocabularyMeanInputTownSort("songjiang_maogang")
          }else if(this.data.jinshanRadio == "jinshan_all"){
              this.onVocabularyMeanInputCountySort( "jinshan")
          }else if(this.data.jinshanRadio == "jinshan_caojing"){
              this.onVocabularyMeanInputTownSort( "jinshan_caojing")
          }else if(this.data.jinshanRadio == "jinshan_fengjing"){
              this.onVocabularyMeanInputTownSort( "jinshan_fengjing")
          }else if(this.data.jinshanRadio == "jinshan_ganxiang"){
              this.onVocabularyMeanInputTownSort( "jinshan_ganxiang")
          }else if(this.data.jinshanRadio == "jinshan_langxia"){
              this.onVocabularyMeanInputTownSort( "jinshan_langxia")
          }else if(this.data.jinshanRadio == "jinshan_lvxiang"){
              this.onVocabularyMeanInputTownSort( "jinshan_lvxiang")
          }else if(this.data.jinshanRadio == "jinshan_qianyu"){
              this.onVocabularyMeanInputTownSort( "jinshan_qianyu")
          }else if(this.data.jinshanRadio == "jinshan_shanyang"){
              this.onVocabularyMeanInputTownSort( "jinshan_shanyang")
          }else if(this.data.jinshanRadio == "jinshan_tinglin"){
              this.onVocabularyMeanInputTownSort( "jinshan_tinglin")
          }else if(this.data.jinshanRadio == "jinshan_xinnong"){
              this.onVocabularyMeanInputTownSort( "jinshan_xinnong")
          }else if(this.data.jinshanRadio == "jinshan_xingta"){
              this.onVocabularyMeanInputTownSort( "jinshan_xingta")
          }else if(this.data.jinshanRadio == "jinshan_zhuhang"){
              this.onVocabularyMeanInputTownSort( "jinshan_zhuhang")
          }else if(this.data.jinshanRadio == "jinshan_zhujing"){
              this.onVocabularyMeanInputTownSort( "jinshan_zhujing")
          }else if(this.data.jinshanRadio == "jinshan_jinshanwei"){
              this.onVocabularyMeanInputTownSort( "jinshan_jinshanwei")
          }else if(this.data.qingpuRadio == "qingpu_all"){
              this.onVocabularyMeanInputCountySort( "qingpu")
          }else if(this.data.qingpuRadio == "qingpu_baihe"){
              this.onVocabularyMeanInputTownSort( "qingpu_baihe")
          }else if(this.data.qingpuRadio == "qingpu_daying"){
              this.onVocabularyMeanInputTownSort( "qingpu_daying")
          }else if(this.data.qingpuRadio == "qingpu_fengxi"){
              this.onVocabularyMeanInputTownSort( "qingpu_fengxi")
          }else if(this.data.qingpuRadio == "qingpu_huancheng"){
              this.onVocabularyMeanInputTownSort( "qingpu_huancheng")
          }else if(this.data.qingpuRadio == "qingpu_jinze"){
              this.onVocabularyMeanInputTownSort( "qingpu_jinze")
          }else if(this.data.qingpuRadio == "qingpu_liansheng"){
              this.onVocabularyMeanInputTownSort( "qingpu_liansheng")
          }else if(this.data.qingpuRadio == "qingpu_liantang"){
              this.onVocabularyMeanInputTownSort( "qingpu_liantang")
          }else if(this.data.qingpuRadio == "qingpu_shangta"){
              this.onVocabularyMeanInputTownSort( "qingpu_shangta")
          }else if(this.data.qingpuRadio == "qingpu_shenxiang"){
              this.onVocabularyMeanInputTownSort( "qingpu_shenxiang")
          }else if(this.data.qingpuRadio == "qingpu_xiceng"){
              this.onVocabularyMeanInputTownSort( "qingpu_xiceng")
          }else if(this.data.qingpuRadio == "qingpu_xiaozheng"){
              this.onVocabularyMeanInputTownSort( "qingpu_xiaozheng")
          }else if(this.data.qingpuRadio == "qingpu_xujing"){
              this.onVocabularyMeanInputTownSort( "qingpu_xujing")
          }else if(this.data.qingpuRadio == "qingpu_huaxin"){
            this.onVocabularyMeanInputTownSort("qingpu_huaxin")
          }else if(this.data.qingpuRadio == "qingpu_yingzhong"){
              this.onVocabularyMeanInputTownSort( "qingpu_yingzhong")
          }else if(this.data.qingpuRadio == "qingpu_zhaotun"){
              this.onVocabularyMeanInputTownSort( "qingpu_zhaotun")
          }else if(this.data.qingpuRadio == "qingpu_zhaoxiang"){
              this.onVocabularyMeanInputTownSort( "qingpu_zhaoxiang")
          }else if(this.data.qingpuRadio == "qingpu_zhengdian"){
              this.onVocabularyMeanInputTownSort( "qingpu_zhengdian")
          }else if(this.data.qingpuRadio == "qingpu_chonggu"){
              this.onVocabularyMeanInputTownSort( "qingpu_chonggu")
          }else if(this.data.qingpuRadio == "qingpu_zhujiajiao"){
              this.onVocabularyMeanInputTownSort( "qingpu_zhujiajiao")
          }else if(this.data.qingpuRadio == "qingpu_xianghuaqiao"){
              this.onVocabularyMeanInputTownSort( "qingpu_xianghuaqiao")
          }else if(this.data.qingpuRadio == "qingpu_qingpuzhen"){
              this.onVocabularyMeanInputTownSort( "qingpu_qingpuzhen")
          }else if(this.data.fengxianRadio == "fengxian_all"){
              this.onVocabularyMeanInputCountySort( "fengxian")
          }else if(this.data.fengxianRadio == "fengxian_fengcheng"){
              this.onVocabularyMeanInputTownSort( "fengxian_fengcheng")
          }else if(this.data.fengxianRadio == "fengxian_fengxin"){
              this.onVocabularyMeanInputTownSort( "fengxian_fengxin")
          }else if(this.data.fengxianRadio == "fengxian_guangming"){
              this.onVocabularyMeanInputTownSort( "fengxian_guangming")
          }else if(this.data.fengxianRadio == "fengxian_hongmiao"){
              this.onVocabularyMeanInputTownSort( "fengxian_hongmiao")
          }else if(this.data.fengxianRadio == "fengxian_huqiao"){
              this.onVocabularyMeanInputTownSort( "fengxian_huqiao")
          }else if(this.data.fengxianRadio == "fengxian_jianghai"){
              this.onVocabularyMeanInputTownSort( "fengxian_jianghai")
          }else if(this.data.fengxianRadio == "fengxian_jinhui"){
              this.onVocabularyMeanInputTownSort( "fengxian_jinhui")
          }else if(this.data.fengxianRadio == "fengxian_nanqiao"){
              this.onVocabularyMeanInputTownSort( "fengxian_nanqiao")
          }else if(this.data.fengxianRadio == "fengxian_pingan"){
              this.onVocabularyMeanInputTownSort( "fengxian_pingan")
          }else if(this.data.fengxianRadio == "fengxian_qianqiao"){
              this.onVocabularyMeanInputTownSort( "fengxian_qianqiao")
          }else if(this.data.fengxianRadio == "fengxian_qingcun"){
              this.onVocabularyMeanInputTownSort( "fengxian_qingcun")
          }else if(this.data.fengxianRadio == "fengxian_shaochang"){
              this.onVocabularyMeanInputTownSort( "fengxian_shaochang")
          }else if(this.data.fengxianRadio == "fengxian_situan"){
              this.onVocabularyMeanInputTownSort( "fengxian_situan")
          }else if(this.data.fengxianRadio == "fengxian_tairi"){
              this.onVocabularyMeanInputTownSort( "fengxian_tairi")
          }else if(this.data.fengxianRadio == "fengxian_tangwai"){
              this.onVocabularyMeanInputTownSort( "fengxian_tangwai")
          }else if(this.data.fengxianRadio == "fengxian_touqiao"){
              this.onVocabularyMeanInputTownSort( "fengxian_touqiao")
          }else if(this.data.fengxianRadio == "fengxian_wuqiao"){
              this.onVocabularyMeanInputTownSort( "fengxian_wuqiao")
          }else if(this.data.fengxianRadio == "fengxian_xidu"){
              this.onVocabularyMeanInputTownSort( "fengxian_xidu")
          }else if(this.data.fengxianRadio == "fengxian_xiaotang"){
              this.onVocabularyMeanInputTownSort( "fengxian_xiaotang")
          }else if(this.data.fengxianRadio == "fengxian_xinsi"){
              this.onVocabularyMeanInputTownSort( "fengxian_xinsi")
          }else if(this.data.fengxianRadio == "fengxian_zhelin"){
              this.onVocabularyMeanInputTownSort( "fengxian_zhelin")
          }else if(this.data.fengxianRadio == "fengxian_zhuanghang"){
              this.onVocabularyMeanInputTownSort( "fengxian_zhuanghang")
          }else if(this.data.fengxianRadio == "fengxian_zhelin_nanshanhua"){
              this.onVocabularyMeanInputTownSort( "fengxian_zhelin_nanshanhua")
          }else if(this.data.chuanshaRadio == "chuansha_all"){
              this.onVocabularyMeanInputCountySort( "chuansha")
          }else if(this.data.chuanshaRadio == "chuansha_beicai"){
              this.onVocabularyMeanInputTownSort( "chuansha_beicai")
          }else if(this.data.chuanshaRadio == "chuansha_caolu"){
              this.onVocabularyMeanInputTownSort( "chuansha_caolu")
          }else if(this.data.chuanshaRadio == "chuansha_gaodong"){
              this.onVocabularyMeanInputTownSort( "chuansha_gaodong")
          }else if(this.data.chuanshaRadio == "chuansha_gaohang"){
              this.onVocabularyMeanInputTownSort( "chuansha_gaohang")
          }else if(this.data.chuanshaRadio == "chuansha_gaonan"){
              this.onVocabularyMeanInputTownSort( "chuansha_gaonan")
          }else if(this.data.chuanshaRadio == "chuansha_gaoqiao"){
              this.onVocabularyMeanInputTownSort( "chuansha_gaoqiao")
          }else if(this.data.chuanshaRadio == "chuansha_heqing"){
              this.onVocabularyMeanInputTownSort( "chuansha_heqing")
          }else if(this.data.chuanshaRadio == "chuansha_huamu"){
              this.onVocabularyMeanInputTownSort( "chuansha_huamu")
          }else if(this.data.chuanshaRadio == "chuansha_jiangzhen"){
              this.onVocabularyMeanInputTownSort( "chuansha_jiangzhen")
          }else if(this.data.chuanshaRadio == "chuansha_shiwan"){
              this.onVocabularyMeanInputTownSort( "chuansha_shiwan")
          }else if(this.data.chuanshaRadio == "chuansha_jinqiao"){
              this.onVocabularyMeanInputTownSort( "chuansha_jinqiao")
          }else if(this.data.chuanshaRadio == "chuansha_lingqiao"){
              this.onVocabularyMeanInputTownSort( "chuansha_lingqiao")
          }else if(this.data.chuanshaRadio == "chuansha_liuli"){
              this.onVocabularyMeanInputTownSort( "chuansha_liuli")
          }else if(this.data.chuanshaRadio == "chuansha_tangzhen"){
              this.onVocabularyMeanInputTownSort( "chuansha_tangzhen")
          }else if(this.data.chuanshaRadio == "chuansha_wanggang"){
              this.onVocabularyMeanInputTownSort( "chuansha_wanggang")
          }else if(this.data.chuanshaRadio == "chuansha_yanqiao"){
              this.onVocabularyMeanInputTownSort( "chuansha_wanggang")
          }else if(this.data.chuanshaRadio == "chuansha_yangsi"){
              this.onVocabularyMeanInputTownSort( "chuansha_yangsi")
          }else if(this.data.chuanshaRadio == "chuansha_yangyuan"){
              this.onVocabularyMeanInputTownSort( "chuansha_yangyuan")
          }else if(this.data.chuanshaRadio == "chuansha_yangjing"){
              this.onVocabularyMeanInputTownSort( "chuansha_yangjing")
          }else if(this.data.chuanshaRadio == "chuangsha_zhangjiang"){
              this.onVocabularyMeanInputTownSort( "chuangsha_zhangjiang")
          }else if(this.data.chuanshaRadio == "chuansha_zhangqiao"){
              this.onVocabularyMeanInputTownSort( "chuansha_zhangqiao")
          }else if(this.data.chuanshaRadio == "chuansha_chuanshazhen"){
              this.onVocabularyMeanInputTownSort( "chuansha_chuanshazhen")
          }else if(this.data.nanhuiRadio == "nanhui_all"){
              this.onVocabularyMeanInputCountySort( "nanhui")
          }else if(this.data.nanhuiRadio == "nanhui_binhai"){
              this.onVocabularyMeanInputTownSort( "nanhui_binhai")
          }else if(this.data.nanhuiRadio == "nanhui_datuan"){
              this.onVocabularyMeanInputTownSort( "nanhui_datuan")
          }else if(this.data.nanhuiRadio == "nanhui_donghai"){
              this.onVocabularyMeanInputTownSort( "nanhui_donghai")
          }else if(this.data.nanhuiRadio == "nanhui_hangtou"){
              this.onVocabularyMeanInputTownSort( "nanhui_hangtou")
          }else if(this.data.nanhuiRadio == "nanhui_hengmian"){
              this.onVocabularyMeanInputTownSort( "nanhui_hengmian")
          }else if(this.data.nanhuiRadio == "nanhui_huanglu"){
              this.onVocabularyMeanInputTownSort( "nanhui_huanglu")
          }else if(this.data.nanhuiRadio == "nanhui_kangqiao"){
              this.onVocabularyMeanInputTownSort( "nanhui_kangqiao")
          }else if(this.data.nanhuiRadio == "nanhui_laogang"){
              this.onVocabularyMeanInputTownSort( "nanhui_laogang")
          }else if(this.data.nanhuiRadio == "nanhui_liuzao"){
              this.onVocabularyMeanInputTownSort( "nanhui_liuzao")
          }else if(this.data.nanhuiRadio == "nanhui_nicheng"){
              this.onVocabularyMeanInputTownSort( "nanhui_nicheng")
          }else if(this.data.nanhuiRadio == "nanhui_pengzhen"){
              this.onVocabularyMeanInputTownSort( "nanhui_pengzhen")
          }else if(this.data.nanhuiRadio == "nanhui_sandun"){
              this.onVocabularyMeanInputTownSort( "nanhui_sandun")
          }else if(this.data.nanhuiRadio == "nanhui_sanzao"){
              this.onVocabularyMeanInputTownSort( "nanhui_sanzao")
          }else if(this.data.nanhuiRadio == "nanhui_shuyuan"){
              this.onVocabularyMeanInputTownSort( "nanhui_shuyuan")
          }else if(this.data.nanhuiRadio == "nanhui_tanzhi"){
              this.onVocabularyMeanInputTownSort( "nanhui_tanzhi")
          }else if(this.data.nanhuiRadio == "nanhui_waxie"){
              this.onVocabularyMeanInputTownSort( "nanhui_waxie")
          }else if(this.data.nanhuiRadio == "nanhui_wanxiang"){
              this.onVocabularyMeanInputTownSort( "nanhui_wanxiang")
          }else if(this.data.nanhuiRadio == "nanhui_xiasha"){
              this.onVocabularyMeanInputTownSort( "nanhui_xiasha")
          }else if(this.data.nanhuiRadio == "nanhui_xinchang"){
              this.onVocabularyMeanInputTownSort( "nanhui_xinchang")
          }else if(this.data.nanhuiRadio == "nanhui_xingang"){
              this.onVocabularyMeanInputTownSort( "nanhui_xingang")
          }else if(this.data.nanhuiRadio == "nanhui_xuanqiao"){
              this.onVocabularyMeanInputTownSort( "nanhui_xuanqiao")
          }else if(this.data.nanhuiRadio == "nanhui_yancang"){
              this.onVocabularyMeanInputTownSort( "nanhui_yancang")
          }else if(this.data.nanhuiRadio == "nanhui_zhoupu"){
              this.onVocabularyMeanInputTownSort( "nanhui_zhoupu")
          }else if(this.data.nanhuiRadio == "nanhui_zhuqiao"){
              this.onVocabularyMeanInputTownSort( "nanhui_zhuqiao")
          }else if(this.data.nanhuiRadio == "nanhui_luchaogang"){
              this.onVocabularyMeanInputTownSort( "nanhui_luchaogang")
          }else if(this.data.jiadingRadio == "jiading_all"){
              this.onVocabularyMeanInputCountySort( "jiading")
          }else if(this.data.jiadingRadio == "jiading_anting"){
              this.onVocabularyMeanInputTownSort( "jiading_anting")
          }else if(this.data.jiadingRadio == "jiading_fengbang"){
              this.onVocabularyMeanInputTownSort( "jiading_fengbang")
          }else if(this.data.jiadingRadio == "jiading_huating"){
              this.onVocabularyMeanInputTownSort( "jiading_huating")
          }else if(this.data.jiadingRadio == "jiading_jiangqiao"){
              this.onVocabularyMeanInputTownSort( "jiading_jiangqiao")
          }else if(this.data.jiadingRadio == "jiading_loutang"){
              this.onVocabularyMeanInputTownSort( "jiading_loutang")
          }else if(this.data.jiadingRadio == "jiading_malu"){
              this.onVocabularyMeanInputTownSort( "jiading_malu")
          }else if(this.data.jiadingRadio == "jiading_nanxiang"){
              this.onVocabularyMeanInputTownSort( "jiading_nanxiang")
          }else if(this.data.jiadingRadio == "jiading_tanghang"){
              this.onVocabularyMeanInputTownSort( "jiading_tanghang")
          }else if(this.data.jiadingRadio == "jiading_taopu"){
              this.onVocabularyMeanInputTownSort( "jiading_taopu")
          }else if(this.data.jiadingRadio == "jiading_waigang"){
              this.onVocabularyMeanInputTownSort( "jiading_waigang")
          }else if(this.data.jiadingRadio == "jiading_wangxin"){
              this.onVocabularyMeanInputTownSort( "jiading_wangxin")
          }else if(this.data.jiadingRadio == "jiading_zhenru"){
              this.onVocabularyMeanInputTownSort( "jiading_zhenru")
          }else if(this.data.jiadingRadio == "jiading_jiadingzhen"){
              this.onVocabularyMeanInputTownSort( "jiading_jiadingzhen")
          }else if(this.data.baoshanRadio == "baoshan_all"){
              this.onVocabularyMeanInputCountySort( "baoshan")
          }else if(this.data.baoshanRadio == "baoshan_dachang"){
              this.onVocabularyMeanInputTownSort( "baoshan_dachang")
          }else if(this.data.baoshanRadio == "baoshan_fengtang"){
              this.onVocabularyMeanInputTownSort( "baoshan_fengtang")
          }else if(this.data.baoshanRadio == "baoshan_gucun"){
              this.onVocabularyMeanInputTownSort( "baoshan_gucun")
          }else if(this.data.baoshanRadio == "baoshan_liuhang"){
              this.onVocabularyMeanInputTownSort( "baoshan_liuhang")
          }else if(this.data.baoshanRadio == "baoshan_jiangwan"){
              this.onVocabularyMeanInputTownSort( "baoshan_jiangwan")
          }else if(this.data.baoshanRadio == "baoshan_luodian"){
              this.onVocabularyMeanInputTownSort( "baoshan_luodian")
          }else if(this.data.baoshanRadio == "baoshan_luojing"){
              this.onVocabularyMeanInputTownSort( "baoshan_luojing")
          }else if(this.data.baoshanRadio == "baoshan_luonan"){
              this.onVocabularyMeanInputTownSort( "baoshan_luonan")
          }else if(this.data.baoshanRadio == "baoshan_miaohang"){
              this.onVocabularyMeanInputTownSort( "baoshan_miaohang")
          }else if(this.data.baoshanRadio == "baoshan_pengpu"){
              this.onVocabularyMeanInputTownSort( "baoshan_pengpu")
          }else if(this.data.baoshanRadio == "baoshan_shengqiao"){
              this.onVocabularyMeanInputTownSort( "baoshan_shengqiao")
          }else if(this.data.baoshanRadio == "baoshan_songnan"){
              this.onVocabularyMeanInputTownSort( "baoshan_songnan")
          }else if(this.data.baoshanRadio == "baoshan_wusong"){
              this.onVocabularyMeanInputTownSort( "baoshan_wusong")
          }else if(this.data.baoshanRadio == "baoshan_wujiaochang"){
              this.onVocabularyMeanInputTownSort( "baoshan_wujiaochang")
          }else if(this.data.baoshanRadio == "baoshan_shuangcaodun"){
              this.onVocabularyMeanInputTownSort( "baoshan_shuangcaodun")
          }else if(this.data.chongmingRadio == "chongming_all"){
              this.onVocabularyMeanInputCountySort( "chongming")
          }else if(this.data.chongmingRadio == "chongming_chenjia"){
              this.onVocabularyMeanInputTownSort( "chongming_chenjia")
          }else if(this.data.chongmingRadio == "chongming_gangyan"){
            this.onVocabularyMeanInputTownSort( "chongming_gangyan")
          }
        }
    ...
    if(this.data.val != ""){
      if(this.data.type == "onVocabularyKnown"){  //如果选中的是知其字的情况下
        if(this.data.shanghaiValueAll == true){
          ...
          this.onVocabularyKnownReachTown("songjiang_maogang")
        }else if(this.data.jinshanRadio == "jinshan_all"){
        ...
        if(this.data.shanghaiValueAll == true){
          ...
          this.onVocabularyUnKnownReachTown("songjiang_maogang")
        }else if(this.data.jinshanRadio == "jinshan_all"){
  ...
  songjiangChange: function(e){
    ...
    }else if(e.detail.value == "songjiang_maogang"){
      this.advanceChangeUniversal("泖港")
      this.setData({
        songjiangRadio: "songjiang_maogang"
      })
    }else{
  ...
  onVocabularyKnownInputCountySort(whichCountyInput){  //搜县名的且有排序的
    this.setData({
        page: 0  //先把page页设置为零
      })
      db.collection("vocabulary")
  ...
  onVocabularyKnownInputTownSort(whichTownInput){  //搜镇名的且的排序的
    this.setData({
        page: 0  //先把page页设置为零
      })
      db.collection("vocabulary")
  ...
  onVocabularyUnKnownInputCountySort(whichCountyInput){  //搜县名的且有排序的
    this.setData({
        page: 0  //先把page页设置为零
      })
      db.collection("vocabulary")
  ...
  onVocabularyUnKnownInputTownSort(whichTownInput){  //搜镇名的且有排序的
    this.setData({
        page: 0  //先把page页设置为零
      })
      db.collection("vocabulary")
  ...
  //以下是几个查释义的批量搜索函数
  onVocabularyMeanInputCounty(whichCountyInput){  //无排序的
    this.setData({
        page: 0  //先把page页设置为零
      })
      db.collection("vocabulary")
  ...
  onVocabularyMeanInputCountySort(whichCountyInput){  //有排序的
    this.setData({
        page: 0  //先把page页设置为零
      })
      db.collection("vocabulary")
  ...
  onVocabularyMeanInputTown(whichTownInput){  //无排序的
    this.setData({
        page: 0  //先把page页设置为零
      })
      db.collection("vocabulary")
  ...
  onVocabularyMeanInputTownSort(whichTownInput){  //有排序的
    this.setData({
        page: 0  //先把page页设置为零
      })
      db.collection("vocabulary")
  ...
  //同样地，以下是6个触底时用的函数
  onVocabularyKnownReachCountySort(whichCountyInput){  //有排序的
    ...
    db.collection("vocabulary")
      ...
      .then(res=>{  //获取到数据后
        ...
        let oldList = this.data.list  //定义一个旧数组为本页面的预置
        let newList = VocabularyKnownList  //定义一个新数组为获取到的data
        oldList = oldList.concat(newList)  //将新数组加到旧数组里
        if(newList != ""){  //若新数组(获取到的data)不为空的话
          this.setData({
            list: oldList  //就设置为旧加新的数组
  ...
  onVocabularyKnownReachCounty(whichCountyInput){  //无排序的
    var val = this.data.val
    let pageList = this.data.page
    pageList = pageList + 20
    this.setData({  //把获取页的数据链接过去
  ...
  onVocabularyKnownReachTownSort(whichTownInput){  //有排序的
    var val = this.data.val
    let pageList = this.data.page
        pageList = pageList + 20
        this.setData({  //把获取页的数据链接过去
  ...
  onVocabularyKnownReachTown(whichTownInput){  //无排序的
    var val = this.data.val
    let pageList = this.data.page
        pageList = pageList + 20
        this.setData({  //把获取页的数据链接过去
  ...
  onVocabularyUnKnownReachCountySort(whichCountyInput){  //有排序的
    var val = this.data.val
    let pageList = this.data.page
    pageList = pageList + 20
    this.setData({  //把获取页的数据链接过去
  ...
  onVocabularyUnKnownReachCounty(whichCountyInput){  //无排序的
    var val = this.data.val
    let pageList = this.data.page
    pageList = pageList + 20
    this.setData({  //把获取页的数据链接过去
  ...
  onVocabularyUnKnownReachTownSort(whichTownInput){  //有排序的
    var val = this.data.val
    let pageList = this.data.page
    pageList = pageList + 20
    this.setData({  //把获取页的数据链接过去
  ...
  onVocabularyUnKnownReachTown(whichTownInput){  //无排序的
    var val = this.data.val
    let pageList = this.data.page
    pageList = pageList + 20
    this.setData({  //把获取页的数据链接过去
  ...
  onVocabularyMeanReachCountySort(whichCountyInput){  //有排序的
    var val = this.data.val
    let pageList = this.data.page
    pageList = pageList + 20
    this.setData({  //把获取页的数据链接过去
  ...
  onVocabularyMeanReachCounty(whichCountyInput){  //无排序的
    var val = this.data.val
    let pageList = this.data.page
    pageList = pageList + 20
    this.setData({  //把获取页的数据链接过去
  ...
  onVocabularyMeanReachTownSort(whichTownInput){  //有排序的
    var val = this.data.val
    let pageList = this.data.page
    pageList = pageList + 20
    this.setData({  //把获取页的数据链接过去
  ...
  onVocabularyMeanReachTown(whichTownInput){  //无排序的
    var val = this.data.val
    let pageList = this.data.page
    pageList = pageList + 20
    this.setData({  //把获取页的数据链接过去
