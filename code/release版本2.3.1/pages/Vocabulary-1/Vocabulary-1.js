...
Page({
  ...
  data: {
    ...
    baoshan_yanghang_checked:false,
    ...
    chongming_hengsha_checked:false
  },
  ...
  enterInput:function(e){  //搜索函数
    ...
    if(val != ''){  //假使值不等于空额能介
      if(this.data.type == "onVocabularyUnKnown"){  //假使是查查词条不知其字能介
         ...
         }else if(this.data.baoshanRadio == "baoshan_yanghang"){
             this.onVocabularyUnKnownInputTown("baoshan_yanghang")
         ...
         }else if(this.data.chongmingRadio == "chongming_hengsha"){
          this.onVocabularyUnKnownInputTown("chongming_hengsha")
        }
          ...
          if(this.data.shanghaiValueAll == true){
            ...
            this.onVocabularyKnownInputTown( "qingpu_yingzhong")
              ...
              this.onVocabularyKnownInputTown( "baoshan_yanghang")
          }else if(this.data.baoshanRadio == "baoshan_wujiaochang"){
              ...
              this.onVocabularyKnownInputTown( "chongming_hengsha")
          }
          ...
          if(this.data.shanghaiValueAll == true){
            ...
            this.onVocabularyMeanInputTown("qingpu_huaxin")
              ...
              this.onVocabularyMeanInputTown("baoshan_yanghang")
          }else if(this.data.baoshanRadio == "baoshan_wujiaochang"){
            ...
            this.onVocabularyMeanInputTown( "chongming_hengsha")
          }
      }
    }else{   //假使值是空额
      this.setData({
      ...
      if(this.data.type == "onVocabularyKnown"){  //如果选中的是知其字的情况下
        if(this.data.shanghaiValueAll == true){
          ...
          this.onVocabularyKnownReachTown("qingpu_huaxin")
            ...
            this.onVocabularyKnownReachTown ("baoshan_yanghang")
        }else if(this.data.baoshanRadio == "baoshan_wujiaochang"){
          ...
          this.onVocabularyKnownReachTown( "chongming_hengsha")
        }
        ...
        if(this.data.shanghaiValueAll == true){
          ...
          this.onVocabularyUnKnownReachTown("qingpu_huaxin")
            ...
            this.onVocabularyUnKnownReachTown("baoshan_yanghang")
        }else if(this.data.baoshanRadio == "baoshan_wujiaochang"){
          ...
          this.onVocabularyUnKnownReachTown( "chongming_hengsha")
        }
      }else{  //若选中的是查释义的情况下
        if(this.data.shanghaiValueAll == true){
              let pageList = this.data.page
  ...
  baoshanChange: function(e){
    ...
    }else if(e.detail.value == "baoshan_yanghang"){
      this.advanceChangeUniversal("杨行")
      this.setData({
        baoshanRadio: "baoshan_yanghang"
      })
  ...
  chongmingChange: function(e){
    ...
    }else if(e.detail.value == "chongming_hengsha"){
      this.advanceChangeUniversal("横沙岛")
      this.setData({
        chongmingRadio: "chongming_hengsha"
      })
    }else{
  ...
  // 按首字拼音排序（保留原有卡片展开/合拢状态）
sortByFirstChar() {
  const list = this.data.list;
  if (!list || list.length === 0) {
    wx.showToast({ title: '暂无数据可排序', icon: 'none' });
    return;
  }

  // 深拷贝原数组，避免直接修改原数据（保留 toggle 等状态）
  const sortedList = [...list].sort((a, b) => {
    const charA = a.vocabulary ? a.vocabulary.charAt(0) : '';
    const charB = b.vocabulary ? b.vocabulary.charAt(0) : '';
    // 使用 localeCompare 按拼音排序，支持中文
  ...
  wx.showToast({ title: '已按首字排序', icon: 'success', duration: 1000 });
  },
